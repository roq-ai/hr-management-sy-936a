  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless HR processes with HR Management System - Your all-in-one solution for employee data, vacations, time tracking, payrolls, and performance evaluations."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless HR processes with HR Management System - Your all-in-one solution for employee data, vacations, time tracking, payrolls, and performance evaluations.`}
            </Text>
            <Box
